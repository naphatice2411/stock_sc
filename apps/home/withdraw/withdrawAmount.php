<?php
    ...
    $ret='
    <form id="withdrawAmountForm" action="'.site_url('ajax/home/withdraw/addToCart').'" method="post" enctype="multipart/form-data" class="form-horizontal">'.
  ...
  $ret.='<div class="form-group">'.
        ...
        '<div class="form-group">'.
            '<label for="inputDept" class="col-sm-2 control-label">จำนวนที่ต้องการเบิก</label>'.
